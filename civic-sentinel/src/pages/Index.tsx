...
const WELCOME_MESSAGE = "Welcome to Civic_ai – where your business embarks on a journey to navigate the regulatory landscape with the precision of a modern-day wizard. Let us guide you to stay compliant, informed, and ahead of the curve.";
      ...
      <div className="h-screen w-full flex flex-col md:flex-row shadow-lg rounded-lg">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center  p-8 overflow-y-scroll">
          <div className="w-full space-y-8 text-center mb-8 animate-fade-down">
            <h1 className="text-4xl font-bold tracking-tight">Civic_ai</h1>
